...
![@startRowIndexパラメーターとパラメーターの値を入力してください @maximumRows](efficiently-paging-through-large-amounts-of-data-vb/_static/image7.png)
...
[![データの2番目のページに表示されるレコードが返されます。](efficiently-paging-through-large-amounts-of-data-vb/_static/image9.png)](efficiently-paging-through-large-amounts-of-data-vb/_static/image8.png)
...
[![製品名によって並べ替えられたデータは、カスタムページングを使用してページングされます。](efficiently-paging-through-large-amounts-of-data-vb/_static/image20.png)](efficiently-paging-through-large-amounts-of-data-vb/_static/image19.png)
...
[![現在のページに表示されているデータのみが並べ替えられます](efficiently-paging-through-large-amounts-of-data-vb/_static/image23.png)](efficiently-paging-through-large-amounts-of-data-vb/_static/image22.png)
