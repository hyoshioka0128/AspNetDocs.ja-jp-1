...
---
# <a name="iteration-2--make-the-application-look-nice-c"></a>繰り返し #2 – アプリケーションの外観を良くする (C#)

[マイクロソフト](https://github.com/microsoft)

[コードをダウンロード](iteration-2-make-the-application-look-nice-cs/_static/contactmanager_2_cs1.zip)
...
[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image1.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image1.png)

**図 01**: ASP.NET MVC アプリケーションの既定の外観 ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image2.png)します )
...
[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image2.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image3.png)

**図 02**: mvc デザイン ギャラリーASP.NET ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image4.png)します )
...
[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image3.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image5.png)

**図 03**: Web からダウンロードしたファイルのブロックを解除する ([フルサイズの画像を表示するには クリック](iteration-2-make-the-application-look-nice-cs/_static/image6.png))

[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image4.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image7.png)

**図 04**: ソリューション エクスプローラでファイルを上書きする ([フルサイズの画像を表示するにはクリック](iteration-2-make-the-application-look-nice-cs/_static/image8.png))

[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image5.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image9.png)

**図 05**: [プロジェクト名] を ContactManager に置き換える ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image10.png)します )

これらの手順を完了すると、Web アプリケーションは新しいデザインを使用します。 図 6 のページは、10 月のデザインでの連絡先マネージャー アプリケーションの外観を示しています。

[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image6.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image11.png)

**図 06**: 10 月のテンプレートを使用した ContactManager ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image12.png)します)
...
[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image7.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image13.png)

**図 07**: mvc 連絡先マネージャー デザインASP.NET ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image14.png))
...
[![[New Project]\(新しいプロジェクト\) ダイアログ ボックス](iteration-2-make-the-application-look-nice-cs/_static/image8.jpg)](iteration-2-make-the-application-look-nice-cs/_static/image15.png)

**図 08**: 選択されたタブと選択されていないタブ ([フルサイズの画像を表示する をクリック](iteration-2-make-the-application-look-nice-cs/_static/image16.png)して )
