...
---
# <a name="iteration-4--make-the-application-loosely-coupled-c"></a>繰り返し #4 – アプリケーションを疎結合にする (C#)

[マイクロソフト](https://github.com/microsoft)

[コードをダウンロード](iteration-4-make-the-application-loosely-coupled-cs/_static/contactmanager_4_cs1.zip)
...
**リスト 1 - モデル\IContactManager リポジトリ.cs**
...
**リスト 2 - モデル\エンティティコンタクトマネージャーリポジトリ.cs**
...
**リスト 5 - モデル\IContactManager サービス.cs**
...
**リスト 7 - モデル\検証\モデルステートラッパー.cs**

[!code-csharp[Main](iteration-4-make-the-application-loosely-coupled-cs/samples/sample7.cs)]

**リスト 8 - モデル\検証\I検証ディクショナリ.cs**
